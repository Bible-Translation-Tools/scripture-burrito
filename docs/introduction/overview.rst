...
In this WACS fork, the schema narrows several fields so that Resource Container-derived content and Wycliffe Associates repositories describe the same project the same way every time.
